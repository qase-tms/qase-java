# Qase Integration in Cucumber 7

This guide provides comprehensive instructions for integrating Qase with Cucumber 7 using Gherkin tags and the Qase Java API.

> **Configuration:** For complete configuration reference including all available options, environment variables, and examples, see the reporter [README](../../qase-cucumber-v7-reporter/README.md).
...
**Alternative:** You can also use `qase.config.json` in your project root to configure settings. See the [README](../../qase-cucumber-v7-reporter/README.md) for details.
...
3. See the [examples directory](../../examples/cucumber7/) for complete Maven/Gradle configuration
...
**Solution:**
1. Verify Cucumber version compatibility (v7.x required)
...
- [README](../../qase-cucumber-v7-reporter/README.md) — Configuration reference and setup guide
...
- [Examples](../../examples/cucumber7/) — Complete example projects with Maven and Gradle
