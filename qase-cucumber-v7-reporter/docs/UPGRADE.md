...
**Gradle After (v4):**
```groovy
testImplementation 'io.qase:qase-cucumber-v7-reporter:4.1.32'
```
...
- [ ] Maven/Gradle dependency updated from `qase-cucumber7-jvm` to `qase-cucumber-v7-reporter` v4.1.32
