...
The Cucumber 7 reporter can auto-generate test cases
...
To execute Cucumber 7 tests and report them to Qase.io, run the command:
...
Qase Cucumber 7 reporter can be configured in multiple ways:
