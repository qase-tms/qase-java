# Junit4-Kotlin-Gradle Example

This is a sample project demonstrating how to write and execute tests using the Junit4 framework with Kotlin and Gradle.
...
1. Clone this repository by running the following command:
   ...
   cd qase-java/examples/kotlin/junit4
   ```
