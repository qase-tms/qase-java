# Cucumber7-GradleKts Example

This is a sample project demonstrating how to write and execute tests using the Cucumber 7 framework with Gradle(Kotlin).
...
1. Clone this repository by running the following command:
   ...
   cd qase-java/examples/cucumber7/cucumber7-gradlekts-junit5
   ```
