# Junit4-Maven Example

This is a sample project demonstrating how to write and execute tests using the Junit4 framework with Maven.
...
1. Clone this repository by running the following command:
   ...
   cd qase-java/examples/junit4/junit4-maven
   ```
