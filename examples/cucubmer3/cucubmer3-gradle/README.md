# Cucumber3-Gradle Example

This is a sample project demonstrating how to write and execute tests using the Cucumber 3 framework with Gradle.
...
1. Clone this repository by running the following command:
   ...
   cd qase-java/examples/cucumber3/cucumber3-gradle
   ```
