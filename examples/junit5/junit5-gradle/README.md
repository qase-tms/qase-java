...
This is a sample project demonstrating how to write and execute tests using the Junit5 framework with Gradle.
...
1. Clone this repository by running the following command:
   ...
   cd qase-java/examples/junit5/junit5-gradle
   ```
