# Cucumber6-Maven Example

This is a sample project demonstrating how to write and execute tests using the Cucumber 6 framework with Maven.
...
1. Clone this repository by running the following command:
   ...
   cd qase-java/examples/cucumber6/cucumber6-maven
   ```
