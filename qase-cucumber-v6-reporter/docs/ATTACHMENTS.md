# Attachments in Cucumber 6

This guide covers how to attach files, screenshots, logs, and other content to your Qase test results using the Cucumber 6 reporter.

---

## Overview

Qase Cucumber 6 Reporter supports attaching various types of content to test results:
...
Import: `import io.qase.cucumber6.Qase;`
...
All methods are static on the `Qase` class. Import: `io.qase.cucumber6.Qase`
