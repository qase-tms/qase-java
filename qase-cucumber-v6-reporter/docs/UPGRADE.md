...
**Gradle After (v4):**
```groovy
testImplementation 'io.qase:qase-cucumber-v6-reporter:4.1.33'
```
...
- [ ] Maven/Gradle dependency updated from `qase-cucumber6-jvm` to `qase-cucumber-v6-reporter` v4.1.33
