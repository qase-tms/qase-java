...
The Cucumber 6 reporter can auto-generate test cases
...
To execute Cucumber 6 tests and report them to Qase.io, run the command:
...
You can try it with the example project at [`examples/cucumber6`](../examples/cucumber6/).
...
Qase Cucumber 6 reporter can be configured in multiple ways:
