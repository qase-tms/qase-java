# Attachments in Cucumber 4

This guide covers how to attach files, screenshots, logs, and other content to your Qase test results using the Cucumber 4 reporter.

---

## Overview

Qase Cucumber 4 Reporter supports attaching various types of content to test results:
...
Import: `import io.qase.cucumber4.Qase;`
...
All methods are static on the `Qase` class. Import: `io.qase.cucumber4.Qase`
