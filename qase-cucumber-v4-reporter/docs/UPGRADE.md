...
**Gradle After (v4):**
```groovy
testImplementation 'io.qase:qase-cucumber-v4-reporter:4.1.32'
```
...
- [ ] Maven/Gradle dependency updated from `qase-cucumber4-jvm` to `qase-cucumber-v4-reporter` v4.1.32
