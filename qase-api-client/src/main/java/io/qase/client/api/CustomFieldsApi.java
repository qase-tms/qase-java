...
public class CustomFieldsApi {
     ...
     */
    public okhttp3.Call getCustomFieldsCall(GetCustomFieldsFiltersParameter filters, Integer limit, Integer offset, final ApiCallback _callback) throws QaseException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCustomFieldsValidateBeforeCall(GetCustomFieldsFiltersParameter filters, Integer limit, Integer offset, final ApiCallback _callback) throws QaseException {
     ...
     */
    public CustomFieldsResponse getCustomFields(GetCustomFieldsFiltersParameter filters, Integer limit, Integer offset) throws QaseException {
     ...
     */
    public ApiResponse<CustomFieldsResponse> getCustomFieldsWithHttpInfo(GetCustomFieldsFiltersParameter filters, Integer limit, Integer offset) throws QaseException {
     ...
     */
    public okhttp3.Call getCustomFieldsAsync(GetCustomFieldsFiltersParameter filters, Integer limit, Integer offset, final ApiCallback<CustomFieldsResponse> _callback) throws QaseException {
