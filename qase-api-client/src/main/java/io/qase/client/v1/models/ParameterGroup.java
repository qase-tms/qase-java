...
public class ParameterGroup {
  ...
  public ParameterGroup addItemsItem(ParameterSingle itemsItem) {
    if (this.items == null) {
   ...
   * @return the ParameterGroup instance itself
   */
  public ParameterGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, parameterGroup.items)&&
        Objects.equals(this.additionalProperties, parameterGroup.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParameterGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ParameterGroup is not found in the empty JSON string", ParameterGroup.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ParameterGroup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParameterGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParameterGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParameterGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParameterGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<ParameterGroup>() {
           @Override
           public void write(JsonWriter out, ParameterGroup value) throws IOException {
           ...
           @Override
           public ParameterGroup read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ParameterGroup instance = thisAdapter.fromJsonTree(jsonObj);
