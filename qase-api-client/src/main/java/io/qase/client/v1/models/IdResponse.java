...
public class IdResponse {
   ...
   * @return the IdResponse instance itself
   */
  public IdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, idResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, idResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IdResponse is not found in the empty JSON string", IdResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IdResponse>() {
           ...
           public IdResponse read(JsonReader in) throws IOException {
             ...
             IdResponse instance = thisAdapter.fromJsonTree(jsonObj);
