...
public class CustomFieldValue {
   ...
   * @return the CustomFieldValue instance itself
   */
  public CustomFieldValue putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, customFieldValue.id) &&
        ...
        Objects.equals(this.additionalProperties, customFieldValue.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomFieldValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomFieldValue is not found in the empty JSON string", CustomFieldValue.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomFieldValue>() {
           ...
           public CustomFieldValue read(JsonReader in) throws IOException {
             ...
             CustomFieldValue instance = thisAdapter.fromJsonTree(jsonObj);
