...
public class SystemField {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, slug, defaultValue, isRequired, entity, type, options);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SystemField.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SystemField` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
