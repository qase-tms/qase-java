...
public class Plan {
  ...
  public Plan id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public Plan title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public Plan description(@javax.annotation.Nullable String description) {
  ...
  public Plan casesCount(@javax.annotation.Nullable Integer casesCount) {
  ...
  public Plan createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public Plan updatedAt(@javax.annotation.Nullable OffsetDateTime updatedAt) {
  ...
  @Deprecated
  public Plan created(@javax.annotation.Nullable String created) {
  ...
  @Deprecated
  public Plan updated(@javax.annotation.Nullable String updated) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, title, description, casesCount, createdAt, updatedAt, created, updated, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "title", "description", "cases_count", "created_at", "updated_at", "created", "updated"));
