...
public class Run {
  ...
  public Run id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public Run runId(@javax.annotation.Nullable Long runId) {
    this.runId = runId;
    return this;
  }
  ...
  public Run title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public Run status(@javax.annotation.Nullable Integer status) {
    this.status = status;
    return this;
  }
  ...
  public Run statusText(@javax.annotation.Nullable String statusText) {
  ...
  public Run startTime(@javax.annotation.Nullable OffsetDateTime startTime) {
  ...
  public Run endTime(@javax.annotation.Nullable OffsetDateTime endTime) {
  ...
  public Run _public(@javax.annotation.Nullable Boolean _public) {
  ...
  public Run stats(@javax.annotation.Nullable RunStats stats) {
    this.stats = stats;
    return this;
  }
  ...
  public Run timeSpent(@javax.annotation.Nullable Long timeSpent) {
  ...
  public Run elapsedTime(@javax.annotation.Nullable Long elapsedTime) {
  ...
  public Run environment(@javax.annotation.Nullable RunEnvironment environment) {
  ...
  public Run milestone(@javax.annotation.Nullable RunMilestone milestone) {
  ...
  public Run customFields(@javax.annotation.Nullable List<CustomFieldValue> customFields) {
  ...
  public Run tags(@javax.annotation.Nullable List<TagValue> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public Run cases(@javax.annotation.Nullable List<Long> cases) {
    this.cases = cases;
    return this;
  }
  ...
  public Run planId(@javax.annotation.Nullable Long planId) {
    this.planId = planId;
    return this;
  }
  ...
  public Run configurations(@javax.annotation.Nullable List<Long> configurations) {
  ...
  public Run externalIssue(@javax.annotation.Nullable RunExternalIssue externalIssue) {
  ...
  public void setExternalIssue(@javax.annotation.Nullable RunExternalIssue externalIssue) {
    this.externalIssue = externalIssue;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "run_id", "title", "description", "status", "status_text", "start_time", "end_time", "public", "stats", "time_spent", "elapsed_time", "environment", "milestone", "custom_fields", "tags", "cases", "plan_id", "configurations", "external_issue"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Run.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Run is not found in the empty JSON string", Run.openapiRequiredFields.toString()));
        }
      }
