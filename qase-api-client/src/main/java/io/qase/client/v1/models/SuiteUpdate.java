...
public class SuiteUpdate {
   ...
   * @return the SuiteUpdate instance itself
   */
  public SuiteUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, suiteUpdate.title) &&
        ...
        Objects.equals(this.additionalProperties, suiteUpdate.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuiteUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SuiteUpdate is not found in the empty JSON string", SuiteUpdate.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SuiteUpdate>() {
           ...
           public SuiteUpdate read(JsonReader in) throws IOException {
             ...
             SuiteUpdate instance = thisAdapter.fromJsonTree(jsonObj);
