...
public class HashResponse {
  ...
  public HashResponse status(@javax.annotation.Nullable Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public HashResponse result(@javax.annotation.Nullable HashResponseAllOfResult result) {
    this.result = result;
    return this;
  }
  ...
  public void setResult(@javax.annotation.Nullable HashResponseAllOfResult result) {
    this.result = result;
  }
   ...
   * @return the HashResponse instance itself
   */
  public HashResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, hashResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, hashResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HashResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in HashResponse is not found in the empty JSON string", HashResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HashResponse>() {
           ...
           public HashResponse read(JsonReader in) throws IOException {
             ...
             HashResponse instance = thisAdapter.fromJsonTree(jsonObj);
