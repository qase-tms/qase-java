...
public class ConfigurationListResponse {
  ...
  public ConfigurationListResponse status(@javax.annotation.Nullable Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public ConfigurationListResponse result(@javax.annotation.Nullable ConfigurationListResponseAllOfResult result) {
    this.result = result;
    return this;
  }
  ...
  public void setResult(@javax.annotation.Nullable ConfigurationListResponseAllOfResult result) {
    this.result = result;
  }
   ...
   * @return the ConfigurationListResponse instance itself
   */
  public ConfigurationListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, configurationListResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, configurationListResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfigurationListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConfigurationListResponse is not found in the empty JSON string", ConfigurationListResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConfigurationListResponse>() {
           ...
           public ConfigurationListResponse read(JsonReader in) throws IOException {
             ...
             ConfigurationListResponse instance = thisAdapter.fromJsonTree(jsonObj);
