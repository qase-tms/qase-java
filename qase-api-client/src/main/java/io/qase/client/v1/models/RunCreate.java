...
public class RunCreate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, description, includeAllCases, cases, isAutotest, environmentId, environmentSlug, milestoneId, planId, authorId, tags, configurations, customField, startTime, endTime);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunCreate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RunCreate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
