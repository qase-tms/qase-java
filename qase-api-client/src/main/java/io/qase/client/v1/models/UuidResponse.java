...
public class UuidResponse {
   ...
   * @return the UuidResponse instance itself
   */
  public UuidResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, uuidResponse.status) &&
        Objects.equals(this.result, uuidResponse.result)&&
        Objects.equals(this.additionalProperties, uuidResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UuidResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UuidResponse is not found in the empty JSON string", UuidResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UuidResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UuidResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UuidResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UuidResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UuidResponse>() {
           @Override
           public void write(JsonWriter out, UuidResponse value) throws IOException {
           ...
           @Override
           public UuidResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UuidResponse instance = thisAdapter.fromJsonTree(jsonObj);
