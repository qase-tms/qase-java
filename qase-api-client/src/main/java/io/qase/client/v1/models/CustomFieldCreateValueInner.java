...
public class CustomFieldCreateValueInner {
   ...
   * @return the CustomFieldCreateValueInner instance itself
   */
  public CustomFieldCreateValueInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, customFieldCreateValueInner.id) &&
        ...
        Objects.equals(this.additionalProperties, customFieldCreateValueInner.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomFieldCreateValueInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomFieldCreateValueInner is not found in the empty JSON string", CustomFieldCreateValueInner.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomFieldCreateValueInner>() {
           ...
           public CustomFieldCreateValueInner read(JsonReader in) throws IOException {
             ...
             CustomFieldCreateValueInner instance = thisAdapter.fromJsonTree(jsonObj);
