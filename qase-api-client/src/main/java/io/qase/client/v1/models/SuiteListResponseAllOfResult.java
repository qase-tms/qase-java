...
public class SuiteListResponseAllOfResult {
  ...
  @javax.annotation.Nullable
  private List<Suite> entities = new ArrayList<>();

  public SuiteListResponseAllOfResult() {
  }

  public SuiteListResponseAllOfResult total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public SuiteListResponseAllOfResult filtered(@javax.annotation.Nullable Integer filtered) {
  ...
  public SuiteListResponseAllOfResult count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public SuiteListResponseAllOfResult entities(@javax.annotation.Nullable List<Suite> entities) {
  ...
  public void setEntities(@javax.annotation.Nullable List<Suite> entities) {
    this.entities = entities;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuiteListResponseAllOfResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SuiteListResponseAllOfResult is not found in the empty JSON string", SuiteListResponseAllOfResult.openapiRequiredFields.toString()));
        }
      }
