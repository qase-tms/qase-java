...
public class AttachmentUploadsResponse {
   ...
   * @return the AttachmentUploadsResponse instance itself
   */
  public AttachmentUploadsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, attachmentUploadsResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, attachmentUploadsResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachmentUploadsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AttachmentUploadsResponse is not found in the empty JSON string", AttachmentUploadsResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AttachmentUploadsResponse>() {
           ...
           public AttachmentUploadsResponse read(JsonReader in) throws IOException {
             ...
             AttachmentUploadsResponse instance = thisAdapter.fromJsonTree(jsonObj);
