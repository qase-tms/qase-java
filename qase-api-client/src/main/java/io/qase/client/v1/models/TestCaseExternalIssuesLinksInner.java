...
public class TestCaseExternalIssuesLinksInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(caseId, externalIssues);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestCaseExternalIssuesLinksInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestCaseExternalIssuesLinksInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
