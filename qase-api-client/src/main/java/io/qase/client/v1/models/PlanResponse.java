...
public class PlanResponse {
  ...
  public PlanResponse status(@javax.annotation.Nullable Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public PlanResponse result(@javax.annotation.Nullable PlanDetailed result) {
    this.result = result;
    return this;
  }
  ...
  public void setResult(@javax.annotation.Nullable PlanDetailed result) {
    this.result = result;
  }
   ...
   * @return the PlanResponse instance itself
   */
  public PlanResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, planResponse.status) &&
        Objects.equals(this.result, planResponse.result)&&
        Objects.equals(this.additionalProperties, planResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlanResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PlanResponse is not found in the empty JSON string", PlanResponse.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `result`
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        PlanDetailed.validateJsonElement(jsonObj.get("result"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PlanResponse>() {
           ...
           public PlanResponse read(JsonReader in) throws IOException {
             ...
             PlanResponse instance = thisAdapter.fromJsonTree(jsonObj);
