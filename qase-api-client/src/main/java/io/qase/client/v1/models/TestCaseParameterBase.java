...
public class TestCaseParameterBase {
   ...
   * @return the TestCaseParameterBase instance itself
   */
  public TestCaseParameterBase putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestCaseParameterBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TestCaseParameterBase is not found in the empty JSON string", TestCaseParameterBase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestCaseParameterBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestCaseParameterBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestCaseParameterBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestCaseParameterBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestCaseParameterBase.class));

       return (TypeAdapter<T>) new TypeAdapter<TestCaseParameterBase>() {
           @Override
           public void write(JsonWriter out, TestCaseParameterBase value) throws IOException {
           ...
           @Override
           public TestCaseParameterBase read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TestCaseParameterBase instance = thisAdapter.fromJsonTree(jsonObj);
