...
public class TestStepCreate {
  ...
  public TestStepCreate action(String action) {
    this.action = action;
    return this;
  }
  ...
  **/
  ...
  public TestStepCreate expectedResult(String expectedResult) {
  ...
  **/
  ...
  public TestStepCreate data(String data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  @Deprecated
  public TestStepCreate position(Integer position) {
  ...
  **/
  ...
  public TestStepCreate attachments(List<String> attachments) {
  ...
  **/
  ...
  public TestStepCreate steps(List<Object> steps) {
    this.steps = steps;
    return this;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action, expectedResult, data, position, attachments, steps);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestStepCreate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestStepCreate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
