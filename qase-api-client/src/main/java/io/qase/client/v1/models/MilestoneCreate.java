...
public class MilestoneCreate {
   ...
   * @return the MilestoneCreate instance itself
   */
  public MilestoneCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, milestoneCreate.title) &&
        ...
        Objects.equals(this.additionalProperties, milestoneCreate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, status, dueDate, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MilestoneCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MilestoneCreate is not found in the empty JSON string", MilestoneCreate.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MilestoneCreate.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MilestoneCreate>() {
           ...
           public MilestoneCreate read(JsonReader in) throws IOException {
             ...
             MilestoneCreate instance = thisAdapter.fromJsonTree(jsonObj);
