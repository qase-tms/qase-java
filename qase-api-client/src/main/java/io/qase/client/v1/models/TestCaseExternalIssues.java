...
public class TestCaseExternalIssues {
   ...
   * @return the TestCaseExternalIssues instance itself
   */
  public TestCaseExternalIssues putAdditionalProperty(String key, Object value) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, links, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestCaseExternalIssues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TestCaseExternalIssues is not found in the empty JSON string", TestCaseExternalIssues.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TestCaseExternalIssues>() {
           ...
           public TestCaseExternalIssues read(JsonReader in) throws IOException {
             ...
             TestCaseExternalIssues instance = thisAdapter.fromJsonTree(jsonObj);
