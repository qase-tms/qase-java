  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlanDetailedAllOfCases.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PlanDetailedAllOfCases is not found in the empty JSON string", PlanDetailedAllOfCases.openapiRequiredFields.toString()));
        }
      }
