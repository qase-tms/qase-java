...
public class SystemFieldOption {
   ...
   * @return the SystemFieldOption instance itself
   */
  public SystemFieldOption putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SystemFieldOption systemFieldOption = (SystemFieldOption) o;
    return Objects.equals(this.id, systemFieldOption.id) &&
        Objects.equals(this.title, systemFieldOption.title) &&
        Objects.equals(this.slug, systemFieldOption.slug) &&
        Objects.equals(this.color, systemFieldOption.color) &&
        Objects.equals(this.icon, systemFieldOption.icon) &&
        Objects.equals(this.isDefault, systemFieldOption.isDefault) &&
        Objects.equals(this.readOnly, systemFieldOption.readOnly)&&
        Objects.equals(this.additionalProperties, systemFieldOption.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, title, slug, color, icon, isDefault, readOnly, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SystemFieldOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SystemFieldOption is not found in the empty JSON string", SystemFieldOption.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemFieldOption.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemFieldOption' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemFieldOption> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemFieldOption.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemFieldOption>() {
           @Override
           public void write(JsonWriter out, SystemFieldOption value) throws IOException {
           ...
           @Override
           public SystemFieldOption read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SystemFieldOption instance = thisAdapter.fromJsonTree(jsonObj);
