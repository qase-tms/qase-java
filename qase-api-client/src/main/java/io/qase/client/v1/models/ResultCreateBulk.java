...
public class ResultCreateBulk {
   ...
   * @return the ResultCreateBulk instance itself
   */
  public ResultCreateBulk putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResultCreateBulk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ResultCreateBulk is not found in the empty JSON string", ResultCreateBulk.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResultCreateBulk>() {
           ...
           public ResultCreateBulk read(JsonReader in) throws IOException {
             ...
             ResultCreateBulk instance = thisAdapter.fromJsonTree(jsonObj);
