...
public class QqlTestCase {
  ...
  public QqlTestCase stepsType(@javax.annotation.Nullable StepsTypeEnum stepsType) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QqlTestCase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in QqlTestCase is not found in the empty JSON string", QqlTestCase.openapiRequiredFields.toString()));
        }
      }
