...
public class DefectQuery {
  ...
  public DefectQuery id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public DefectQuery defectId(@javax.annotation.Nonnull Long defectId) {
  ...
  public DefectQuery title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public DefectQuery actualResult(@javax.annotation.Nullable String actualResult) {
  ...
  public DefectQuery severity(@javax.annotation.Nullable String severity) {
  ...
  public DefectQuery status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public DefectQuery milestoneId(@javax.annotation.Nullable Long milestoneId) {
  ...
  public DefectQuery customFields(@javax.annotation.Nullable List<CustomFieldValue> customFields) {
    this.customFields = customFields;
    return this;
  }

  public DefectQuery addCustomFieldsItem(CustomFieldValue customFieldsItem) {
  ...
  public DefectQuery attachments(@javax.annotation.Nullable List<Attachment> attachments) {
    this.attachments = attachments;
    return this;
  }

  public DefectQuery addAttachmentsItem(Attachment attachmentsItem) {
  ...
  public DefectQuery resolved(@javax.annotation.Nullable OffsetDateTime resolved) {
  ...
  @Deprecated
  public DefectQuery memberId(@javax.annotation.Nullable Long memberId) {
  ...
  public DefectQuery authorId(@javax.annotation.Nullable Long authorId) {
  ...
  public DefectQuery externalData(@javax.annotation.Nullable String externalData) {
  ...
  public DefectQuery tags(@javax.annotation.Nullable List<TagValue> tags) {
    this.tags = tags;
    return this;
  }

  public DefectQuery addTagsItem(TagValue tagsItem) {
    if (this.tags == null) {
  ...
  public DefectQuery createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public DefectQuery updatedAt(@javax.annotation.Nullable OffsetDateTime updatedAt) {
   ...
   * @return the DefectQuery instance itself
   */
  public DefectQuery putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, defectQuery.id) &&
        ...
        Objects.equals(this.status, defectQuery.status) &&
        Objects.equals(this.milestoneId, defectQuery.milestoneId) &&
        Objects.equals(this.customFields, defectQuery.customFields) &&
        Objects.equals(this.attachments, defectQuery.attachments) &&
        Objects.equals(this.resolved, defectQuery.resolved) &&
        Objects.equals(this.memberId, defectQuery.memberId) &&
        Objects.equals(this.authorId, defectQuery.authorId) &&
        Objects.equals(this.externalData, defectQuery.externalData) &&
        Objects.equals(this.tags, defectQuery.tags) &&
        Objects.equals(this.createdAt, defectQuery.createdAt) &&
        Objects.equals(this.updatedAt, defectQuery.updatedAt)&&
        Objects.equals(this.additionalProperties, defectQuery.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DefectQuery
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DefectQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DefectQuery is not found in the empty JSON string", DefectQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("actual_result") != null && !jsonObj.get("actual_result").isJsonNull()) && !jsonObj.get("actual_result").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `actual_result` to be a primitive type in the JSON string but got `%s`", jsonObj.get("actual_result").toString()));
      }
      ...
      if ((jsonObj.get("external_data") != null && !jsonObj.get("external_data").isJsonNull()) && !jsonObj.get("external_data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `external_data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("external_data").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DefectQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DefectQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DefectQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DefectQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<DefectQuery>() {
           @Override
           public void write(JsonWriter out, DefectQuery value) throws IOException {
           ...
           @Override
           public DefectQuery read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DefectQuery instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of DefectQuery given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DefectQuery
   * @throws IOException if the JSON string is invalid with respect to DefectQuery
   */
  public static DefectQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DefectQuery.class);
  }

  /**
   * Convert an instance of DefectQuery to an JSON string
   *
   * @return JSON string
   */
