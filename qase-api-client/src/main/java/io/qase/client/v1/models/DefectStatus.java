...
public class DefectStatus {
   ...
   * @return the DefectStatus instance itself
   */
  public DefectStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, defectStatus.status)&&
        Objects.equals(this.additionalProperties, defectStatus.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DefectStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DefectStatus is not found in the empty JSON string", DefectStatus.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DefectStatus.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DefectStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DefectStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DefectStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DefectStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<DefectStatus>() {
           @Override
           public void write(JsonWriter out, DefectStatus value) throws IOException {
           ...
           @Override
           public DefectStatus read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DefectStatus instance = thisAdapter.fromJsonTree(jsonObj);
