...
import io.qase.client.v1.models.SearchResponseAllOfResult;
...
public class SearchResponse {
  ...
  public SearchResponse status(@javax.annotation.Nullable Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public SearchResponse result(@javax.annotation.Nullable SearchResponseAllOfResult result) {
    this.result = result;
    return this;
  }
  ...
  public void setResult(@javax.annotation.Nullable SearchResponseAllOfResult result) {
    this.result = result;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        SearchResponseAllOfResult.validateJsonElement(jsonObj.get("result"));
      }
  }
