...
public class ConfigurationListResponseAllOfResult {
   ...
   * @return the ConfigurationListResponseAllOfResult instance itself
   */
  public ConfigurationListResponseAllOfResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, configurationListResponseAllOfResult.total) &&
        ...
        Objects.equals(this.additionalProperties, configurationListResponseAllOfResult.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfigurationListResponseAllOfResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConfigurationListResponseAllOfResult is not found in the empty JSON string", ConfigurationListResponseAllOfResult.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConfigurationListResponseAllOfResult>() {
           ...
           public ConfigurationListResponseAllOfResult read(JsonReader in) throws IOException {
             ...
             ConfigurationListResponseAllOfResult instance = thisAdapter.fromJsonTree(jsonObj);
