...
public class ConfigurationGroup {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, title, configurations);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfigurationGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfigurationGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
