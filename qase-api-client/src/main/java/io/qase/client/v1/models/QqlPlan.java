...
public class QqlPlan {
   ...
   * @return the QqlPlan instance itself
   */
  public QqlPlan putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, qqlPlan.id) &&
        ...
        Objects.equals(this.additionalProperties, qqlPlan.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QqlPlan.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in QqlPlan is not found in the empty JSON string", QqlPlan.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<QqlPlan>() {
           ...
           public QqlPlan read(JsonReader in) throws IOException {
             ...
             QqlPlan instance = thisAdapter.fromJsonTree(jsonObj);
