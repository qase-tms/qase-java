...
public class ProjectCountsRuns {
   ...
   * @return the ProjectCountsRuns instance itself
   */
  public ProjectCountsRuns putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, projectCountsRuns.total) &&
        ...
        Objects.equals(this.additionalProperties, projectCountsRuns.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(total, active, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectCountsRuns.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProjectCountsRuns is not found in the empty JSON string", ProjectCountsRuns.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectCountsRuns>() {
           ...
           public ProjectCountsRuns read(JsonReader in) throws IOException {
             ...
             ProjectCountsRuns instance = thisAdapter.fromJsonTree(jsonObj);
