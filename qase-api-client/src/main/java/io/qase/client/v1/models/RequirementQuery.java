...
public class RequirementQuery {
  ...
  public RequirementQuery id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public RequirementQuery requirementId(@javax.annotation.Nonnull Long requirementId) {
  ...
  public void setRequirementId(@javax.annotation.Nonnull Long requirementId) {
    this.requirementId = requirementId;
  }


  public RequirementQuery parentId(@javax.annotation.Nullable Long parentId) {
  ...
  public RequirementQuery memberId(@javax.annotation.Nullable Long memberId) {
  ...
  public RequirementQuery title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public RequirementQuery description(@javax.annotation.Nullable String description) {
  ...
  public RequirementQuery status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public RequirementQuery type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public RequirementQuery createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public RequirementQuery updatedAt(@javax.annotation.Nullable OffsetDateTime updatedAt) {
   ...
   * @return the RequirementQuery instance itself
   */
  public RequirementQuery putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, requirementQuery.id) &&
        ...
        Objects.equals(this.additionalProperties, requirementQuery.additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "requirement_id", "parent_id", "member_id", "title", "description", "status", "type", "created_at", "updated_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("requirement_id"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RequirementQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RequirementQuery is not found in the empty JSON string", RequirementQuery.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RequirementQuery>() {
           ...
           public RequirementQuery read(JsonReader in) throws IOException {
             ...
             RequirementQuery instance = thisAdapter.fromJsonTree(jsonObj);
