...
public class ProjectResponse {
  ...
  public ProjectResponse status(@javax.annotation.Nullable Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public ProjectResponse result(@javax.annotation.Nullable Project result) {
    this.result = result;
    return this;
  }
  ...
  public void setResult(@javax.annotation.Nullable Project result) {
    this.result = result;
  }
   ...
   * @return the ProjectResponse instance itself
   */
  public ProjectResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, projectResponse.status) &&
        Objects.equals(this.result, projectResponse.result)&&
        Objects.equals(this.additionalProperties, projectResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProjectResponse is not found in the empty JSON string", ProjectResponse.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `result`
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        Project.validateJsonElement(jsonObj.get("result"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectResponse>() {
           ...
           public ProjectResponse read(JsonReader in) throws IOException {
             ...
             ProjectResponse instance = thisAdapter.fromJsonTree(jsonObj);
