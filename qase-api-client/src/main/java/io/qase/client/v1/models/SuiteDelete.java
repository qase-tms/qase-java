...
public class SuiteDelete {
   ...
   * @return the SuiteDelete instance itself
   */
  public SuiteDelete putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.destinationId, suiteDelete.destinationId)&&
        Objects.equals(this.additionalProperties, suiteDelete.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuiteDelete.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SuiteDelete is not found in the empty JSON string", SuiteDelete.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SuiteDelete>() {
           ...
           public SuiteDelete read(JsonReader in) throws IOException {
             ...
             SuiteDelete instance = thisAdapter.fromJsonTree(jsonObj);
