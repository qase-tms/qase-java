...
public class EnvironmentListResponseAllOfResult {
   ...
   * @return the EnvironmentListResponseAllOfResult instance itself
   */
  public EnvironmentListResponseAllOfResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, environmentListResponseAllOfResult.total) &&
        ...
        Objects.equals(this.additionalProperties, environmentListResponseAllOfResult.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnvironmentListResponseAllOfResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EnvironmentListResponseAllOfResult is not found in the empty JSON string", EnvironmentListResponseAllOfResult.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("entities") != null && !jsonObj.get("entities").isJsonNull()) {
        ...
        if (jsonArrayentities != null) {
          ...
          for (int i = 0; i < jsonArrayentities.size(); i++) {
            Environment.validateJsonElement(jsonArrayentities.get(i));
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EnvironmentListResponseAllOfResult>() {
           ...
           public EnvironmentListResponseAllOfResult read(JsonReader in) throws IOException {
             ...
             EnvironmentListResponseAllOfResult instance = thisAdapter.fromJsonTree(jsonObj);
