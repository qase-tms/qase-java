...
public class PlanUpdate {
   ...
   * @return the PlanUpdate instance itself
   */
  public PlanUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, planUpdate.title) &&
        ...
        Objects.equals(this.additionalProperties, planUpdate.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlanUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PlanUpdate is not found in the empty JSON string", PlanUpdate.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PlanUpdate>() {
           ...
           public PlanUpdate read(JsonReader in) throws IOException {
             ...
             PlanUpdate instance = thisAdapter.fromJsonTree(jsonObj);
