...
public class SharedParameterUpdate {
  ...
  public SharedParameterUpdate addProjectCodesItem(String projectCodesItem) {
   ...
   * @return the SharedParameterUpdate instance itself
   */
  public SharedParameterUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SharedParameterUpdate sharedParameterUpdate = (SharedParameterUpdate) o;
    return Objects.equals(this.title, sharedParameterUpdate.title) &&
        Objects.equals(this.projectCodes, sharedParameterUpdate.projectCodes) &&
        Objects.equals(this.isEnabledForAllProjects, sharedParameterUpdate.isEnabledForAllProjects) &&
        Objects.equals(this.parameters, sharedParameterUpdate.parameters)&&
        Objects.equals(this.additionalProperties, sharedParameterUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, projectCodes, isEnabledForAllProjects, parameters, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SharedParameterUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SharedParameterUpdate is not found in the empty JSON string", SharedParameterUpdate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SharedParameterUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SharedParameterUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SharedParameterUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SharedParameterUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<SharedParameterUpdate>() {
           @Override
           public void write(JsonWriter out, SharedParameterUpdate value) throws IOException {
           ...
           @Override
           public SharedParameterUpdate read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SharedParameterUpdate instance = thisAdapter.fromJsonTree(jsonObj);
