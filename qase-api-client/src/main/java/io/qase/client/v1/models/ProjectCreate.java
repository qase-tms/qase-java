...
public class ProjectCreate {
   ...
   * @return the ProjectCreate instance itself
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, code, description, access, group, settings, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProjectCreate is not found in the empty JSON string", ProjectCreate.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectCreate>() {
           ...
           public ProjectCreate read(JsonReader in) throws IOException {
             ...
             ProjectCreate instance = thisAdapter.fromJsonTree(jsonObj);
