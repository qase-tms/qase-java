...
public class TestStepResultCreate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(position, status, comment, attachments, action, expectedResult, data, steps);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestStepResultCreate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestStepResultCreate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
