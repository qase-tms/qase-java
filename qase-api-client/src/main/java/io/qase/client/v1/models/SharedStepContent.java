...
public class SharedStepContent {
  ...
  @javax.annotation.Nullable
  private List<AttachmentHash> attachments = new ArrayList<>();
  ...
  public SharedStepContent data(@javax.annotation.Nullable String data) {
    this.data = data;
    return this;
  }
  ...
  @Deprecated
  public SharedStepContent hash(@javax.annotation.Nullable String hash) {
    this.hash = hash;
    return this;
  }
  ...
  public SharedStepContent action(@javax.annotation.Nullable String action) {
    this.action = action;
    return this;
  }
  ...
  public SharedStepContent expectedResult(@javax.annotation.Nullable String expectedResult) {
  ...
  public SharedStepContent attachments(@javax.annotation.Nullable List<AttachmentHash> attachments) {
  ...
  public void setAttachments(@javax.annotation.Nullable List<AttachmentHash> attachments) {
    this.attachments = attachments;
  }


  public SharedStepContent steps(@javax.annotation.Nullable List<Object> steps) {
    this.steps = steps;
    return this;
  }

  public SharedStepContent addStepsItem(Object stepsItem) {
    if (this.steps == null) {
   ...
   * @return the SharedStepContent instance itself
   */
  public SharedStepContent putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, sharedStepContent.data) &&
        ...
        Objects.equals(this.steps, sharedStepContent.steps)&&
        Objects.equals(this.additionalProperties, sharedStepContent.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, hash, action, expectedResult, attachments, steps, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("data", "hash", "action", "expected_result", "attachments", "steps"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SharedStepContent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SharedStepContent is not found in the empty JSON string", SharedStepContent.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SharedStepContent>() {
           ...
           public SharedStepContent read(JsonReader in) throws IOException {
             ...
             SharedStepContent instance = thisAdapter.fromJsonTree(jsonObj);
