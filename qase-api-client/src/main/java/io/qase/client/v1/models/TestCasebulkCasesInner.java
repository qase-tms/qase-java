...
public class TestCasebulkCasesInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, preconditions, postconditions, title, severity, priority, behavior, type, layer, isFlaky, authorId, suiteId, milestoneId, automation, status, attachments, steps, tags, params, customField, createdAt, updatedAt, id);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestCasebulkCasesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestCasebulkCasesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
