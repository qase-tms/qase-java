...
public class SearchResponseAllOfResult {
   ...
   * @return the SearchResponseAllOfResult instance itself
   */
  public SearchResponseAllOfResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entities, searchResponseAllOfResult.entities) &&
        ...
        Objects.equals(this.additionalProperties, searchResponseAllOfResult.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(entities, total, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchResponseAllOfResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SearchResponseAllOfResult is not found in the empty JSON string", SearchResponseAllOfResult.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchResponseAllOfResult>() {
           ...
           public SearchResponseAllOfResult read(JsonReader in) throws IOException {
             ...
             SearchResponseAllOfResult instance = thisAdapter.fromJsonTree(jsonObj);
