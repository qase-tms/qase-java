...
public class SharedStepResponse {
  ...
  public SharedStepResponse status(@javax.annotation.Nullable Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public SharedStepResponse result(@javax.annotation.Nullable SharedStep result) {
    this.result = result;
    return this;
  }
  ...
  public void setResult(@javax.annotation.Nullable SharedStep result) {
    this.result = result;
  }
   ...
   * @return the SharedStepResponse instance itself
   */
  public SharedStepResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, sharedStepResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, sharedStepResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SharedStepResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SharedStepResponse is not found in the empty JSON string", SharedStepResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SharedStepResponse>() {
           ...
           public SharedStepResponse read(JsonReader in) throws IOException {
             ...
             SharedStepResponse instance = thisAdapter.fromJsonTree(jsonObj);
