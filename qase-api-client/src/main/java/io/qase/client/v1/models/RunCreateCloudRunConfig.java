...
public class RunCreateCloudRunConfig {
  ...
  **/
   ...
   * @return the RunCreateCloudRunConfig instance itself
   */
  public RunCreateCloudRunConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RunCreateCloudRunConfig runCreateCloudRunConfig = (RunCreateCloudRunConfig) o;
    return Objects.equals(this.browser, runCreateCloudRunConfig.browser)&&
        Objects.equals(this.additionalProperties, runCreateCloudRunConfig.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(browser, additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("browser") != null && !jsonObj.get("browser").isJsonNull()) {
        BrowserEnum.validateJsonElement(jsonObj.get("browser"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RunCreateCloudRunConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RunCreateCloudRunConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RunCreateCloudRunConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RunCreateCloudRunConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<RunCreateCloudRunConfig>() {
           @Override
           public void write(JsonWriter out, RunCreateCloudRunConfig value) throws IOException {
           ...
           @Override
           public RunCreateCloudRunConfig read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RunCreateCloudRunConfig instance = thisAdapter.fromJsonTree(jsonObj);
