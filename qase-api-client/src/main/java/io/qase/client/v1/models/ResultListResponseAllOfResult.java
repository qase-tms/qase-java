...
public class ResultListResponseAllOfResult {
  ...
  public ResultListResponseAllOfResult total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ResultListResponseAllOfResult filtered(@javax.annotation.Nullable Integer filtered) {
  ...
  public ResultListResponseAllOfResult count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public ResultListResponseAllOfResult entities(@javax.annotation.Nullable List<Result> entities) {
  ...
  public void setEntities(@javax.annotation.Nullable List<Result> entities) {
    this.entities = entities;
  }
   ...
   * @return the ResultListResponseAllOfResult instance itself
   */
  public ResultListResponseAllOfResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, resultListResponseAllOfResult.total) &&
        ...
        Objects.equals(this.additionalProperties, resultListResponseAllOfResult.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResultListResponseAllOfResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResultListResponseAllOfResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ResultListResponseAllOfResult is not found in the empty JSON string", ResultListResponseAllOfResult.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("entities") != null && !jsonObj.get("entities").isJsonNull()) {
        ...
        if (jsonArrayentities != null) {
          ...
          for (int i = 0; i < jsonArrayentities.size(); i++) {
            Result.validateJsonElement(jsonArrayentities.get(i));
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResultListResponseAllOfResult>() {
           ...
           public ResultListResponseAllOfResult read(JsonReader in) throws IOException {
             ...
             ResultListResponseAllOfResult instance = thisAdapter.fromJsonTree(jsonObj);
