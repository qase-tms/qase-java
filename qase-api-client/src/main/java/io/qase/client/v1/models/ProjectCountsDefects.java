...
public class ProjectCountsDefects {
   ...
   * @return the ProjectCountsDefects instance itself
   */
  public ProjectCountsDefects putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, projectCountsDefects.total) &&
        ...
        Objects.equals(this.additionalProperties, projectCountsDefects.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(total, open, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectCountsDefects.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProjectCountsDefects is not found in the empty JSON string", ProjectCountsDefects.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectCountsDefects>() {
           ...
           public ProjectCountsDefects read(JsonReader in) throws IOException {
             ...
             ProjectCountsDefects instance = thisAdapter.fromJsonTree(jsonObj);
