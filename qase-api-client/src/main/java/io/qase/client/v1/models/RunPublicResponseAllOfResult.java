...
public class RunPublicResponseAllOfResult {
   ...
   * @return the RunPublicResponseAllOfResult instance itself
   */
  public RunPublicResponseAllOfResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, runPublicResponseAllOfResult.url)&&
        Objects.equals(this.additionalProperties, runPublicResponseAllOfResult.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunPublicResponseAllOfResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunPublicResponseAllOfResult is not found in the empty JSON string", RunPublicResponseAllOfResult.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RunPublicResponseAllOfResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RunPublicResponseAllOfResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RunPublicResponseAllOfResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RunPublicResponseAllOfResult.class));

       return (TypeAdapter<T>) new TypeAdapter<RunPublicResponseAllOfResult>() {
           @Override
           public void write(JsonWriter out, RunPublicResponseAllOfResult value) throws IOException {
           ...
           @Override
           public RunPublicResponseAllOfResult read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RunPublicResponseAllOfResult instance = thisAdapter.fromJsonTree(jsonObj);
