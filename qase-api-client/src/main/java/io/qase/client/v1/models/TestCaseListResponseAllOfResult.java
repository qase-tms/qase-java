...
public class TestCaseListResponseAllOfResult {
  ...
  @javax.annotation.Nullable
  private List<TestCase> entities = new ArrayList<>();

  public TestCaseListResponseAllOfResult() {
  }

  public TestCaseListResponseAllOfResult total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public TestCaseListResponseAllOfResult filtered(@javax.annotation.Nullable Integer filtered) {
  ...
  public TestCaseListResponseAllOfResult count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public TestCaseListResponseAllOfResult entities(@javax.annotation.Nullable List<TestCase> entities) {
  ...
  public void setEntities(@javax.annotation.Nullable List<TestCase> entities) {
    this.entities = entities;
  }
   ...
   * @return the TestCaseListResponseAllOfResult instance itself
   */
  public TestCaseListResponseAllOfResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, testCaseListResponseAllOfResult.total) &&
        ...
        Objects.equals(this.additionalProperties, testCaseListResponseAllOfResult.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestCaseListResponseAllOfResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TestCaseListResponseAllOfResult is not found in the empty JSON string", TestCaseListResponseAllOfResult.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TestCaseListResponseAllOfResult>() {
           ...
           public TestCaseListResponseAllOfResult read(JsonReader in) throws IOException {
             ...
             TestCaseListResponseAllOfResult instance = thisAdapter.fromJsonTree(jsonObj);
