...
public class AttachmentListResponse {
  ...
  public AttachmentListResponse status(@javax.annotation.Nullable Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public AttachmentListResponse result(@javax.annotation.Nullable AttachmentListResponseAllOfResult result) {
    this.result = result;
    return this;
  }
  ...
  public void setResult(@javax.annotation.Nullable AttachmentListResponseAllOfResult result) {
    this.result = result;
  }
   ...
   * @return the AttachmentListResponse instance itself
   */
  public AttachmentListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, attachmentListResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, attachmentListResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachmentListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AttachmentListResponse is not found in the empty JSON string", AttachmentListResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AttachmentListResponse>() {
           ...
           public AttachmentListResponse read(JsonReader in) throws IOException {
             ...
             AttachmentListResponse instance = thisAdapter.fromJsonTree(jsonObj);
