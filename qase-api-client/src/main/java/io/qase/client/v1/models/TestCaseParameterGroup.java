...
public class TestCaseParameterGroup {
   ...
   * @return the TestCaseParameterGroup instance itself
   */
  public TestCaseParameterGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TestCaseParameterGroup testCaseParameterGroup = (TestCaseParameterGroup) o;
    return Objects.equals(this.sharedId, testCaseParameterGroup.sharedId) &&
        Objects.equals(this.type, testCaseParameterGroup.type) &&
        Objects.equals(this.items, testCaseParameterGroup.items)&&
        Objects.equals(this.additionalProperties, testCaseParameterGroup.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestCaseParameterGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TestCaseParameterGroup is not found in the empty JSON string", TestCaseParameterGroup.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestCaseParameterGroup.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("shared_id") != null && !jsonObj.get("shared_id").isJsonNull()) && !jsonObj.get("shared_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `shared_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("shared_id").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestCaseParameterGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestCaseParameterGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestCaseParameterGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestCaseParameterGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<TestCaseParameterGroup>() {
           @Override
           public void write(JsonWriter out, TestCaseParameterGroup value) throws IOException {
           ...
           @Override
           public TestCaseParameterGroup read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TestCaseParameterGroup instance = thisAdapter.fromJsonTree(jsonObj);
