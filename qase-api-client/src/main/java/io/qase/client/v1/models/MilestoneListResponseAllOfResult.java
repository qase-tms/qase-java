...
public class MilestoneListResponseAllOfResult {
  ...
  @javax.annotation.Nullable
  private List<Milestone> entities = new ArrayList<>();

  public MilestoneListResponseAllOfResult() {
  }

  public MilestoneListResponseAllOfResult total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public MilestoneListResponseAllOfResult filtered(@javax.annotation.Nullable Integer filtered) {
  ...
  public MilestoneListResponseAllOfResult count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public MilestoneListResponseAllOfResult entities(@javax.annotation.Nullable List<Milestone> entities) {
  ...
  public void setEntities(@javax.annotation.Nullable List<Milestone> entities) {
    this.entities = entities;
  }
   ...
   * @return the MilestoneListResponseAllOfResult instance itself
   */
  public MilestoneListResponseAllOfResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, milestoneListResponseAllOfResult.total) &&
        ...
        Objects.equals(this.additionalProperties, milestoneListResponseAllOfResult.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MilestoneListResponseAllOfResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MilestoneListResponseAllOfResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MilestoneListResponseAllOfResult is not found in the empty JSON string", MilestoneListResponseAllOfResult.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("entities") != null && !jsonObj.get("entities").isJsonNull()) {
        ...
        if (jsonArrayentities != null) {
          ...
          for (int i = 0; i < jsonArrayentities.size(); i++) {
            Milestone.validateJsonElement(jsonArrayentities.get(i));
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MilestoneListResponseAllOfResult>() {
           ...
           public MilestoneListResponseAllOfResult read(JsonReader in) throws IOException {
             ...
             MilestoneListResponseAllOfResult instance = thisAdapter.fromJsonTree(jsonObj);
