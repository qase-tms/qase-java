...
public class TestCaseUpdate {
  ...
  public TestCaseUpdate stepsType(@javax.annotation.Nullable StepsTypeEnum stepsType) {
   ...
   * @return the TestCaseUpdate instance itself
   */
  public TestCaseUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, testCaseUpdate.description) &&
        ...
        Objects.equals(this.isManual, testCaseUpdate.isManual) &&
        Objects.equals(this.isToBeAutomated, testCaseUpdate.isToBeAutomated) &&
        Objects.equals(this.status, testCaseUpdate.status) &&
        Objects.equals(this.stepsType, testCaseUpdate.stepsType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, preconditions, postconditions, title, severity, priority, behavior, type, layer, isFlaky, suiteId, milestoneId, automation, isManual, isToBeAutomated, status, stepsType, attachments, steps, tags, params, parameters, customField, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "preconditions", "postconditions", "title", "severity", "priority", "behavior", "type", "layer", "is_flaky", "suite_id", "milestone_id", "automation", "isManual", "isToBeAutomated", "status", "steps_type", "attachments", "steps", "tags", "params", "parameters", "custom_field"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestCaseUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TestCaseUpdate is not found in the empty JSON string", TestCaseUpdate.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TestCaseUpdate>() {
           ...
           public TestCaseUpdate read(JsonReader in) throws IOException {
             ...
             TestCaseUpdate instance = thisAdapter.fromJsonTree(jsonObj);
