...
public class EnvironmentUpdate {
   ...
   * @return the EnvironmentUpdate instance itself
   */
  public EnvironmentUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, environmentUpdate.title) &&
        ...
        Objects.equals(this.additionalProperties, environmentUpdate.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnvironmentUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EnvironmentUpdate is not found in the empty JSON string", EnvironmentUpdate.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EnvironmentUpdate>() {
           ...
           public EnvironmentUpdate read(JsonReader in) throws IOException {
             ...
             EnvironmentUpdate instance = thisAdapter.fromJsonTree(jsonObj);
