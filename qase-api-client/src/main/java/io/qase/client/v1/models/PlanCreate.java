...
public class PlanCreate {
   ...
   * @return the PlanCreate instance itself
   */
  public PlanCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, planCreate.title) &&
        ...
        Objects.equals(this.additionalProperties, planCreate.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, description, cases, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlanCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PlanCreate is not found in the empty JSON string", PlanCreate.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PlanCreate>() {
           ...
           public PlanCreate read(JsonReader in) throws IOException {
             ...
             PlanCreate instance = thisAdapter.fromJsonTree(jsonObj);
