...
public class TestCaseParameterSingle {
   ...
   * @return the TestCaseParameterSingle instance itself
   */
  public TestCaseParameterSingle putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestCaseParameterSingle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TestCaseParameterSingle is not found in the empty JSON string", TestCaseParameterSingle.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestCaseParameterSingle.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestCaseParameterSingle.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestCaseParameterSingle' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestCaseParameterSingle> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestCaseParameterSingle.class));

       return (TypeAdapter<T>) new TypeAdapter<TestCaseParameterSingle>() {
           @Override
           public void write(JsonWriter out, TestCaseParameterSingle value) throws IOException {
           ...
           @Override
           public TestCaseParameterSingle read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TestCaseParameterSingle instance = thisAdapter.fromJsonTree(jsonObj);
