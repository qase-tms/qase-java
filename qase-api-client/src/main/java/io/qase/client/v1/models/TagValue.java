...
public class TagValue {
  ...
  public TagValue title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public TagValue internalId(@javax.annotation.Nullable Long internalId) {
  ...
  public void setInternalId(@javax.annotation.Nullable Long internalId) {
    this.internalId = internalId;
  }
   ...
   * @return the TagValue instance itself
   */
  public TagValue putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, tagValue.title) &&
        ...
        Objects.equals(this.additionalProperties, tagValue.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, internalId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("title", "internal_id"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TagValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TagValue is not found in the empty JSON string", TagValue.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TagValue>() {
           ...
           public TagValue read(JsonReader in) throws IOException {
             ...
             TagValue instance = thisAdapter.fromJsonTree(jsonObj);
