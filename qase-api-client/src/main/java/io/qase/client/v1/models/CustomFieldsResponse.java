...
public class CustomFieldsResponse {
  ...
  public CustomFieldsResponse status(@javax.annotation.Nullable Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public CustomFieldsResponse result(@javax.annotation.Nullable CustomFieldsResponseAllOfResult result) {
    this.result = result;
    return this;
  }
   ...
   * @return the CustomFieldsResponse instance itself
   */
  public CustomFieldsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, customFieldsResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, customFieldsResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomFieldsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomFieldsResponse is not found in the empty JSON string", CustomFieldsResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomFieldsResponse>() {
           ...
           public CustomFieldsResponse read(JsonReader in) throws IOException {
             ...
             CustomFieldsResponse instance = thisAdapter.fromJsonTree(jsonObj);
