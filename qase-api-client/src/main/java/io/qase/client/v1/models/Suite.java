...
public class Suite {
   ...
   * @return the Suite instance itself
   */
  public Suite putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, suite.id) &&
        ...
        Objects.equals(this.additionalProperties, suite.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, title, description, preconditions, position, casesCount, parentId, created, updated, createdAt, updatedAt, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Suite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Suite is not found in the empty JSON string", Suite.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Suite>() {
           ...
           public Suite read(JsonReader in) throws IOException {
             ...
             Suite instance = thisAdapter.fromJsonTree(jsonObj);
