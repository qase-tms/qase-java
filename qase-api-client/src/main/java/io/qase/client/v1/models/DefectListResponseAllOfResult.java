...
public class DefectListResponseAllOfResult {
   ...
   * @return the DefectListResponseAllOfResult instance itself
   */
  public DefectListResponseAllOfResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, defectListResponseAllOfResult.total) &&
        ...
        Objects.equals(this.additionalProperties, defectListResponseAllOfResult.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DefectListResponseAllOfResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DefectListResponseAllOfResult is not found in the empty JSON string", DefectListResponseAllOfResult.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("entities") != null && !jsonObj.get("entities").isJsonNull()) {
        ...
        if (jsonArrayentities != null) {
          ...
          for (int i = 0; i < jsonArrayentities.size(); i++) {
            Defect.validateJsonElement(jsonArrayentities.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DefectListResponseAllOfResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DefectListResponseAllOfResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DefectListResponseAllOfResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DefectListResponseAllOfResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DefectListResponseAllOfResult>() {
           @Override
           public void write(JsonWriter out, DefectListResponseAllOfResult value) throws IOException {
           ...
           @Override
           public DefectListResponseAllOfResult read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DefectListResponseAllOfResult instance = thisAdapter.fromJsonTree(jsonObj);
