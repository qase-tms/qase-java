...
import io.qase.client.v1.auth.Authentication;
import io.qase.client.v1.auth.HttpBasicAuth;
import io.qase.client.v1.auth.HttpBearerAuth;
import io.qase.client.v1.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.qase.io/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.qase.io/v1
     ...
     * @return a {@link io.qase.client.v1.ApiClient} object
     */
    ...
    */
     ...
     * @throws io.qase.client.v1.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.qase.client.v1.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.qase.client.v1.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.qase.client.v1.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.qase.client.v1.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.qase.client.v1.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.qase.client.v1.ApiException If fails to update the parameters
     */
     ...
     * @throws io.qase.client.v1.ApiException If fail to serialize the request body object into a string
     */
