...
public class RelationSuiteItem {
   ...
   * @return the RelationSuiteItem instance itself
   */
  public RelationSuiteItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, relationSuiteItem.title) &&
        ...
        Objects.equals(this.additionalProperties, relationSuiteItem.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, publicId, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelationSuiteItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RelationSuiteItem is not found in the empty JSON string", RelationSuiteItem.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RelationSuiteItem>() {
           ...
           public RelationSuiteItem read(JsonReader in) throws IOException {
             ...
             RelationSuiteItem instance = thisAdapter.fromJsonTree(jsonObj);
