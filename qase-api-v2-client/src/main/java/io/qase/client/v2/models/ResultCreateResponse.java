...
import io.qase.client.v2.models.ResultCreateResponseAllOfResult;
...
public class ResultCreateResponse {
  ...
  public ResultCreateResponse status(@javax.annotation.Nullable Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public ResultCreateResponse result(@javax.annotation.Nullable ResultCreateResponseAllOfResult result) {
    this.result = result;
    return this;
  }
  ...
  public void setResult(@javax.annotation.Nullable ResultCreateResponseAllOfResult result) {
    this.result = result;
  }
   ...
   * @return the ResultCreateResponse instance itself
   */
  public ResultCreateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, resultCreateResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, resultCreateResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResultCreateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ResultCreateResponse is not found in the empty JSON string", ResultCreateResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResultCreateResponse>() {
           ...
           public ResultCreateResponse read(JsonReader in) throws IOException {
             ...
             ResultCreateResponse instance = thisAdapter.fromJsonTree(jsonObj);
