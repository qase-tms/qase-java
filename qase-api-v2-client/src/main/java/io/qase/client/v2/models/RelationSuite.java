...
public class RelationSuite {
  ...
  public RelationSuite addDataItem(RelationSuiteItem dataItem) {
    if (this.data == null) {
   ...
   * @return the RelationSuite instance itself
   */
  public RelationSuite putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RelationSuite relationSuite = (RelationSuite) o;
    return Objects.equals(this.data, relationSuite.data)&&
        Objects.equals(this.additionalProperties, relationSuite.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelationSuite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RelationSuite is not found in the empty JSON string", RelationSuite.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RelationSuite.openapiRequiredFields) {
      ...
      if (jsonObj.get("data") != null) {
        ...
        for (int i = 0; i < jsonArraydata.size(); i++) {
          RelationSuiteItem.validateJsonElement(jsonArraydata.get(i));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RelationSuite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RelationSuite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RelationSuite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RelationSuite.class));

       return (TypeAdapter<T>) new TypeAdapter<RelationSuite>() {
           @Override
           public void write(JsonWriter out, RelationSuite value) throws IOException {
           ...
           @Override
           public RelationSuite read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RelationSuite instance = thisAdapter.fromJsonTree(jsonObj);
