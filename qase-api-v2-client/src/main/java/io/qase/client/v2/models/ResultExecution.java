...
public class ResultExecution {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(startTime, endTime, status, duration, stacktrace, thread);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResultExecution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResultExecution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
