  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResultStepData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ResultStepData is not found in the empty JSON string", ResultStepData.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("input_data") != null && !jsonObj.get("input_data").isJsonNull()) && !jsonObj.get("input_data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `input_data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("input_data").toString()));
      }
