...
public class CreateResultsRequestV2 {
   ...
   * @return the CreateResultsRequestV2 instance itself
   */
  public CreateResultsRequestV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.results, createResultsRequestV2.results)&&
        Objects.equals(this.additionalProperties, createResultsRequestV2.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateResultsRequestV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateResultsRequestV2 is not found in the empty JSON string", CreateResultsRequestV2.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateResultsRequestV2>() {
           ...
           public CreateResultsRequestV2 read(JsonReader in) throws IOException {
             ...
             CreateResultsRequestV2 instance = thisAdapter.fromJsonTree(jsonObj);
