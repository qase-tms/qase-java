...
The Cucumber 5 reporter can auto-generate test cases
...
To execute Cucumber 5 tests and report them to Qase.io, run the command:
...
You can try it with the example project at [`examples/cucumber5`](../examples/cucumber5/).
...
Qase Cucumber 5 reporter can be configured in multiple ways:
