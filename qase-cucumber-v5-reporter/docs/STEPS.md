# Test Steps in Cucumber 5

This guide covers how test steps are reported to Qase when using the Cucumber 5 reporter. Cucumber's Gherkin steps are automatically captured — no additional annotations required.

---

## Overview

Cucumber 5 automatically reports every Given/When/Then step in your feature files as a test step in Qase:
...
2. For Maven: Add `--plugin io.qase.cucumber5.QaseEventListener` in `@CucumberOptions` or Surefire configuration
