...
**Gradle After (v4):**
```groovy
testImplementation 'io.qase:qase-cucumber-v5-reporter:4.1.34'
```
...
- [ ] Maven/Gradle dependency updated from `qase-cucumber5-jvm` to `qase-cucumber-v5-reporter` v4.1.34
