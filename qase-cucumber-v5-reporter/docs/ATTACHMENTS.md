# Attachments in Cucumber 5

This guide covers how to attach files, screenshots, logs, and other content to your Qase test results using the Cucumber 5 reporter.

---

## Overview

Qase Cucumber 5 Reporter supports attaching various types of content to test results:
...
Import: `import io.qase.cucumber5.Qase;`
...
All methods are static on the `Qase` class. Import: `io.qase.cucumber5.Qase`
