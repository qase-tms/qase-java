# Attachments in JUnit 4

This guide covers how to attach files, screenshots, logs, and other content to your Qase test results using the JUnit 4 reporter.
...
All attachment methods are static methods in the `io.qase.junit4.Qase` class.
