...
|---|---|
| v4.0.0 - v4.1.33 (current) | New architecture, v2 API, qase.config.json, new annotations |
...
**Gradle After (v4):**
```groovy
testImplementation 'io.qase:qase-junit4-reporter:4.1.33'
```
...
- [ ] Maven/Gradle dependency updated to `qase-junit4-reporter` v4.1.33
