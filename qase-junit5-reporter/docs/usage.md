# Qase Integration in JUnit 5

This guide provides comprehensive instructions for using Qase annotations and API with JUnit 5.

> **Configuration:** For complete configuration reference including all available options, environment variables, and examples, see the reporter [README](../../qase-junit5-reporter/README.md).
...
JUnit 5 supports parameterized tests using `@ParameterizedTest` annotation with various parameter sources.
...
public class ParameterizedTests {
    ...
    static Stream<Arguments> loginDataProvider() {
        return Stream.of(
            Arguments.of("user1@example.com", "password123"),
            Arguments.of("user2@example.com", "securePass456"),
            Arguments.of("user3@example.com", "testPass789")
        );
    }
...
**Configuration Note:** You can also use a `qase.config.json` file at the project root instead of environment variables or system properties. See the [README](../../qase-junit5-reporter/README.md) for details.
...
| JUnit 5 Result | Qase Status | Description |
|----------------|-------------|-------------|
...
| Disabled | skipped | Test was skipped via `@Disabled` |
...
2. Check the AspectJ configuration in the example projects: [examples/junit5/](../../examples/junit5/)
...
- [README](../../qase-junit5-reporter/README.md) — Configuration reference and setup instructions
...
- [Examples](../../examples/junit5/) — Complete example projects with Maven and Gradle configurations
