# Attachments in Cucumber 3

This guide covers how to attach files, screenshots, logs, and other content to your Qase test results using the Cucumber 3 reporter.

---

## Overview

Qase Cucumber 3 Reporter supports attaching various types of content to test results:
...
Import: `import io.qase.cucumber3.Qase;`
...
All methods are static on the `Qase` class. Import: `io.qase.cucumber3.Qase`
