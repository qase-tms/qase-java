...
To update an existing test project using the Qase reporter from version 2 to version 3, follow these steps:
...
The Cucumber 3 reporter can auto-generate test cases and suites from your test data. Subsequent test runs will match the
...
To execute Cucumber 3 tests and report the results to Qase.io, use the following commands:
...
You can try it with the example project located at [`examples/cucumber3`](../examples/cucumber3/).

<p align="center">
  <img width="65%" src="./screenshots/screenshot.png" alt="Qase Cucumber 3 Screenshot">
</p>
...
The Qase Cucumber 3 reporter can be configured in several ways:
...
- **Cucumber**: Version 3.0.2 or higher is required.
