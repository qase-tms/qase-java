# Attachments in TestNG

This guide covers how to attach files, screenshots, logs, and other content to your Qase test results using the TestNG reporter.
...
All attachment methods are static methods in the `io.qase.testng.Qase` class.
