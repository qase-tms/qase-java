# [Qase TestOps](https://qase.io) TestNG Reporter

[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![Maven Central](https://img.shields.io/maven-central/v/io.qase/qase-testng-reporter)](https://mvnrepository.com/artifact/io.qase/qase-testng-reporter)

The Qase TestNG Reporter enables seamless integration between your TestNG tests and [Qase TestOps](https://qase.io), providing automatic test result reporting, test case management, and comprehensive test analytics.
...
```groovy
testImplementation 'io.qase:qase-testng-reporter:4.1.33'
```

> **Note:** The reporter requires AspectJ weaver for step functionality. See the [examples directory](../examples/testng/) for complete Maven and Gradle setup including AspectJ configuration.
...
- **TestNG**: Version 7.0.0 or higher
...
See the [examples directory](../examples/testng/) for complete working examples with Maven and Gradle.
